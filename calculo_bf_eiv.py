...
#variaveis a alterar (informações) SUBSTITUA!!
global nome
nome = "Nome do Engenheiro responsavel"
global cidade
cidade = "Cidade"
global estado
estado = "Estado"

# variaveis do rodapé: SUBSTITUA!!
global endereco_rua
endereco_rua = "rua"
global endereco_numero
endereco_numero = "n° casa/prédio"
global andar
andar = "andar"
global numero_sala_escritorio
numero_sala_escritorio = "n°"
global bairro
bairro = "bairro"
# contatos:
global fone_fixo
fone_fixo = "Telefone de Contato"
global WhatsApp
...
while not fim_pr:
   # Criar um doc
    ...
    texto1 = paragrafo.add_run(f"{nome}\nEngº Civil\n\n\n\n\t\t\t\t\t\t\t\t\t      ")
    ...
    imagem_path = "Logo_empresarial.jpg"
    ...
    data_lugar = documento.add_paragraph(f'{cidade}, {estado}, {formata_data(nova_data)}\n')
    linha_para_assinatura = documento.add_paragraph('__________________________________')
    nome_assinatura = documento.add_paragraph(f'{nome}\nEngº Civil')
    ...
    paragrafo_rodape.text = f"________________________________________________________________________________________________________\n\t\t\t{endereco_rua.upper()}, {endereco_numero} – {andar} – SALA {numero_sala_escritorio} – {bairro.upper()} – {cidade.upper()} – {estado.upper()}\n\t\tFONE: {fone_fixo} – Cel / WhatsApp : {WhatsApp} – e-mail: {email}"
